...
世界没有预设的终极意义，不等于人不能选择在乎什么。一次失败需要认清结果、原因和代价，但不能单独定义整个人生。面对仍值得且可能的目标，可以反复执行“确定方向—采取行动—观察反馈—修正方法”。这部分不要求接受分支理论。完整体系还额外相信：只要方向仍可能并持续行动，人最终会亲身走进由未来自己确认“已经做到”的人生。
...
文字顺序：虚无 → 失败 → 自我 → 行动；第一人称分支收敛由一项独立公理接入。
...
可能性不等于愿望，方向确信也不等于当前方案正确。健康、法律、他人同意、资源、风险与行为后果始终有效。

例如，相信康复方向值得坚持，不等于可以跳过检查或自行停药；相信事业方向有价值，也不等于可以忽略合同、现金流或合作方同意。方向决定是否继续探索，证据决定当前方法是否可用。详见[心理与现实护栏](docs/zh-CN/WELLBEING.md)。
