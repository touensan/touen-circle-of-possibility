...
```mermaid
flowchart TB
    A["① 虚无前提<br/>没有预设终极意义<br/>只排除宇宙级最终评分"]
    B["② 可能性前提<br/>真正可能的状态由总体容纳<br/>不同道路有不同条件与概率"]
    C["③ 自我定义<br/>眼前的我属于更大的分支集体<br/>规定是谁在经历与延续"]
    D["④ 现实方法<br/>行动、看结果、改路线、继续<br/>不行动就不满足适用条件"]
    E["⑤ 收敛公理<br/>上述条件成立时<br/>第一人称最终抵达"]
