...
完整体系还有一个**可选观点**。只要方向仍有现实可能，人也持续行动、学习和修正，完整体系相信：亲身经历的人生最终会走到由未来自己确认“做到了”的那条路。
...
- **想看看这套理论有没有漏洞：** [B 版技术手册](docs/zh-CN/TECHNICAL.md) → [符号化参考](docs/zh-CN/FORMAL_SPEC.md)
  → [未决问题与反对意见](docs/zh-CN/CRITICISM.md)
...
> 翻译状态：简体中文是当前基准。其他语言已有译文，但尚未同步这一版的信息结构和术语；每份译文末尾都标有状态。
